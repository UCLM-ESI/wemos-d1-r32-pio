...
void app_main(void)
{
  ...
  if( xMutex != NULL )
  {
    xTaskCreatePinnedToCore( vTaskRead, "Read Slave 1", 1000, (void *)SLAVE_ID_1, 1, NULL, 0 );
    xTaskCreatePinnedToCore( vTaskRead, "Read Slave 2", 1000, (void *)SLAVE_ID_2, 1, NULL, 0 );
    xTaskCreatePinnedToCore( vTaskWrite, "Write Slave 1", 1000, (void *)SLAVE_ID_1, 1, NULL, 0 );
    xTaskCreatePinnedToCore( vTaskWrite, "Write Slave 2", 1000, (void *)SLAVE_ID_2, 1, NULL, 0 );
  }
}
